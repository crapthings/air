...
export function MetricScoreCard ({ metric, value, reason, isRiskMetric = false, unitLabel = '满分 100' }) {
  return (
    <article className='relative overflow-hidden rounded-[1.5rem] border border-white/80 bg-white p-4 shadow-[0_20px_80px_-45px_rgba(15,23,42,0.45)]'>
      ...
      <div className='relative'>
        ...
        <div className='mt-2 text-xs uppercase tracking-[0.24em] text-slate-400'>{unitLabel}</div>
